 ...
 */
public abstract class AbstractRefListToMap<V extends IDefinition<String>> extends XmlAdapter<ReferenceListWrapper, Map<String, V>>
{
	private final Map<String, V> _map;
	
	protected AbstractRefListToMap(Map<String, V> map)
	{
